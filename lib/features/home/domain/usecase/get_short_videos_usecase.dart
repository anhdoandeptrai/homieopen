...
class GetShortVideosUsecase implements Usecase<List<VideoEntity>, int> {
  final HomeRepository _homeRepository;

  GetShortVideosUsecase({required HomeRepository homeRepository})
      : _homeRepository = homeRepository;

  @override
  Future<Either<Failure, List<VideoEntity>>> call(int page) async {
    return await _homeRepository.getShortVideos(page: page);
  }
}
