...
class GetRecommendedVideosUsecase implements Usecase<List<VideoEntity>, int> {
  final HomeRepository _homeRepository;

  GetRecommendedVideosUsecase({required HomeRepository homeRepository})
      : _homeRepository = homeRepository;

  @override
  Future<Either<Failure, List<VideoEntity>>> call(int page) async {
    return await _homeRepository.getRecommendedVideos(page: page);
  }
}
